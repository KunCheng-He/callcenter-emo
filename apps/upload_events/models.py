from django.db.models import Model, CharField, ForeignKey, SET_NULL, DateTimeField, FileField
...
class UploadEvent(Model):
    """ 上传事件表 """
    # up_user_id = ForeignKey(CustomUser, on_delete=SET_NULL, null=True, related_name='upload_events', verbose_name='上传用户')
